# Supabase `activity_events` Table Setup

To support the separation of activity events from the time_accounts JSON payload, you need to execute the following SQL migration in your Supabase SQL Editor.

This will create the table, configure Row Level Security (RLS) so users can only access their own data, and enable Realtime functionality.
