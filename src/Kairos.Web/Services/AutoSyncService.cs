...
public class AutoSyncService : IAutoSyncService
{
    ...
    private const string EnabledProviderStorageKey = "Kairos_autosync_provider";
    private const string LastSyncStorageKeyPrefix = "Kairos_autosync_lastsync_";
